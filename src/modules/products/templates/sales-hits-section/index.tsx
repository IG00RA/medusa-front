    ...
    <section className="py-[64px] px-[16px] lg:py-[112px] bg-[#F9F9F9] relative">
      ...
      <div className="relative max-w-[932px] mx-auto">
        ...
        >
          {products.map((product) => (
            <SwiperSlide key={product.id}>
              <div className="flex flex-col items-center w-[300px] h-[412px] rounded-[24px] bg-white border border-[#E8E8E8] py-6 px-6">
                <LocalizedClientLink href={`/products/${product.handle}`}>
                  ...
                  <div className="flex flex-col items-center justify-center flex-grow">
                    ...
                    <div className="text-[20px] font-bold text-[var(--color-dark-blue)] mb-6 text-center">
        ...
        <div className="flex justify-center lg:justify-between items-center mt-6 lg:mt-0 lg:absolute lg:inset-0 lg:top-1/2 lg:transform lg:-translate-y-1/2 w-full pointer-events-none">
          <button
            className={`swiper-button-previous pointer-events-auto lg:absolute lg:-left-[64px] min-w-[40px] h-[40px] border ${mergedTheme.borderColor} rounded-full flex items-center justify-center mr-[24px] lg:mr-0 bg-white`}
          >
            <MdArrowBackIosNew size={20} color={mergedTheme.mainColor} />
          </button>
          <button
            className={`swiper-button-nextes pointer-events-auto lg:absolute lg:-right-[60px] min-w-[40px] h-[40px] border ${mergedTheme.borderColor} rounded-full flex items-center justify-center bg-white`}
          >
